...
const commandSpecs: CommandSpec[] = [
  ...
  // --- Cluster commands ---
  {
    ...
    subcommands: [
      ...
      {
        name: 'setslot',
        handler: () => cluster.clusterSetslot(),
        arity: -4,
        flags: ['admin'],
        firstKey: 0,
        lastKey: 0,
      ...
      {
        name: 'addslots',
        handler: () => cluster.clusterAddslots(),
        arity: -3,
        flags: ['admin'],
        firstKey: 0,
        lastKey: 0,
      ...
      {
        name: 'delslots',
        handler: () => cluster.clusterDelslots(),
        arity: -3,
        flags: ['admin'],
        firstKey: 0,
        lastKey: 0,
      ...
      {
        name: 'flushslots',
        handler: () => cluster.clusterFlushslots(),
        arity: 2,
        flags: ['admin'],
        firstKey: 0,
        lastKey: 0,
      ...
      {
        name: 'failover',
        handler: () => cluster.clusterFailover(),
        arity: -2,
        flags: ['admin'],
        firstKey: 0,
        lastKey: 0,
      ...
      {
        name: 'replicate',
        handler: () => cluster.clusterReplicate(),
        arity: 3,
        flags: ['admin'],
        firstKey: 0,
        lastKey: 0,
      ...
      {
        name: 'saveconfig',
        handler: () => cluster.clusterSaveconfig(),
        arity: 2,
        flags: ['admin'],
        firstKey: 0,
        lastKey: 0,
      ...
      },
      {
        ...
        handler: () => cluster.clusterSetConfigEpoch(),
        arity: 3,
        flags: ['admin'],
        firstKey: 0,
        lastKey: 0,
